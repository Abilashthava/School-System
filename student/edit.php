<DOCTYPE html>
	...
	<body>
		...
		?>
		<form action="update.php" method="POST" autocomplete="on" enctype="multipart/form-data">
			<table border="2" cellpadding="10" cellspacing="10">
				...
				<tr>
					...
					<td><img src="<?php echo $row['image'] ?>" alt="<?php echo $row['file_name'] ?>"
							style="width:100px; height:100px;"><input type="file" name="myfile" id="myfile"
							accept="image/jpg"><a href="../student/delete_profile.php?id=<?php echo $id; ?>">delete</a>
					</td>
				...
				<tr>
					...
					<td><input type="text" name="addmission_number" id="addmission_number"
							value="<?php echo $row['addmission_number'] ?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="number" name="nic_number" id="nic_number" value="<?php echo $row['nic_number'] ?>">
					</td>
				</tr>
				<tr>
					<td><label for="date_of_birth">Date Of Birth</label></td>
					<td><input type="date" name="date_of_birth" id="date_of_birth"
							value="<?php echo $row['date_of_birth'] ?>"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="telephone_number" id="telephone_number"
							value="<?php echo $row['telephone_number'] ?>"></td>
				</tr>
				<tr>
